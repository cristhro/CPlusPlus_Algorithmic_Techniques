...
//
// El coste del programa viene dado por la función resuelveCaso() que, a su vez, viene dado por sort(), cuya complejidad es de O(n*logn)
#include <iostream>
#include <algorithm>
...
bool resuelveCaso(){
	...
	sort(atacantes.begin(), atacantes.end());	// O(n*logn)
	sort(defensores.begin(), defensores.end());	// O(n*logn)
